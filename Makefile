...
# coq_makefile -I il -I constr -I infra -I isa -I . ./il/Env.v ./il/IL.v ./il/Var.v ./isa/Val.v ./isa/Exp.v ./constr/Map.v ./constr/CSet.v ./infra/Option.v ./infra/AutoIndTac.v ./infra/EqDec.v ./infra/CoreTactics.v ./infra/DecidableTactics.v ./infra/Util.v ./infra/Monad.v 
#
