...
: sim bot3 SimExt σ σ' -> forall L, prefixSpec false σ L -> prefixSpec false σ' L.
Proof.
...
: sim bot3 SimExt σ σ' -> forall L, prefixSpec true σ' L -> prefixSpec true σ L.
Proof.
  intros. general induction H2.
  - eapply IHprefixSpec.
    eapply sim_reduction_closed; eauto.
...
Proof.
  ...
  - dcr. inv H3; dcr.
    ...
    + intros.
      assert (PS:prefixSpec false x (EEvtExtern evt::nil)). {
        eapply prefixSpec_star_activated; eauto using star2, prefixSpec.
      }
      eapply H5 in PS.
      eapply prefixSpec_extevent in PS; dcr.
      relsimpl.
      eexists; split. eauto.
      right. eapply CIH.
      ...
      eapply prefixSpec_event_closed; eauto.
    + intros.
      assert (PS:prefixSpec true x2 (EEvtExtern evt::nil)). {
        eapply prefixSpec_star_activated; eauto using star2, prefixSpec.
      }
      eapply H8 in PS.
      eapply prefixSpec_extevent' in PS; dcr; eauto.
      eexists; split. eauto.
      right. eapply CIH.
      eapply prefixSpec_event_closed; eauto.
      eapply prefixSpec_event_closed; eauto.
